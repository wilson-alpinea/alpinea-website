    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="relative overflow-hidden px-8 pb-28 pt-40 md:px-16 md:pt-48">
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          ...
          <h1
            className={`${display.className} max-w-5xl text-5xl font-medium leading-[1.05] tracking-tight md:text-7xl`}
          >
          ...
          <p className="mt-10 max-w-2xl text-lg font-light leading-9 text-white/65">
            Escolha entre orientação estratégica, planejamento completo ou
            execução presencial no Japão — sempre com curadoria profunda,
            discrição e precisão operacional.
          </p>
        </div>
      </section>
      ...
      <section className="border-t border-white/10 bg-black px-8 py-32 md:px-16">
        <div className="mx-auto max-w-7xl">
          ...
          <h2
            className={`${display.className} max-w-4xl text-5xl font-medium leading-[1.05] tracking-tight text-white md:text-7xl`}
          >
            O que muda entre
            <br />
            cada formato.
              ...
              <tbody className="text-white/80">
                {[
                  ...
                  <tr key={service} className="border-b border-white/10">
                    ...
                    <td
                      className={`text-center ${design === "—" ? "text-white/25" : design === "Opcional" || design === "Sugestões" ? "text-white/60" : "text-white"}`}
                    >
                      {design}
                    </td>
                    <td
                      className={`text-center ${executive === "—" ? "text-white/25" : "text-white"}`}
                    >
                      {executive}
                    </td>
      ...
      <section className="border-t border-b border-white/10 bg-[#080706] px-8 py-32 md:px-16">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <h2
            className={`${display.className} text-4xl font-medium leading-tight text-white md:text-6xl`}
          >
    ...
    >
      <div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <div>
          ...
          <h2
            className={`${display.className} text-5xl font-medium leading-tight tracking-tight md:text-7xl`}
          >
            {title}
          </h2>
