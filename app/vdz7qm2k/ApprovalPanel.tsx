...
const DAY_7: DayContent = {
  ...
  contexto: [
    ...
    "O dia 10 de maio é um dos dias do Grand Sumo Tournament de Tóquio em maio de 2028 (torneio completo de 9 a 23 de maio) — a venda dos ingressos para o torneio começa dia 10 de abril de 2028.",
  ...
  tarde: {
    ...
    atracaoPrincipal: "Ryogoku Kokugikan - Grand Sumo Tournament 2028",
...
// Dia da semana de cada data do roteiro (04–12 de maio de 2028), exibido
...
const INFO_CARDS = [
  { label: "Aeroporto DOH", Icon: IconPlane },
              ...
              >
                ...
                >
                  {d.badge ? (
                    ...
                    <span className="text-lg font-bold text-[#1B4A73]">
                      {d.day}
                    </span>
                  )}
                </span>
