          ...
          {(() => {
            ...
            return (
              <button
                ...
                className="group relative mx-auto mt-6 block h-full w-full min-h-[220px] flex-1 overflow-hidden rounded-xl border border-[#DDD8CF] bg-white shadow-sm sm:min-h-[260px]"
              >
                <img
                  src={mapa.mapa}
                  alt={mapa.mapaAlt ?? ""}
